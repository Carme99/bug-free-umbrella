...
Describe "Invoke-WingetGoogleChrome" {
    BeforeAll {
        ...
        $scriptRelPath = 'scripts/endpoints/remediation/winget/browsers/GoogleChrome/Invoke-WingetGoogleChrome.ps1'
    ...
    Context "Help & Metadata" {
        It "Declares required .NOTES fields with Version 1.0.0 and Date 2026-08-23" {
            ...
            $raw | Should -Match 'File Name:\s*Invoke-WingetGoogleChrome\.ps1'
    ...
    Context "Behavior" {
        ...
        It "Defers with exit 1 when the app process is running" {
            ...
            Mock Get-Process { [pscustomobject] @{ ProcessName = 'chrome' } }
