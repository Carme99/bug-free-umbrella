...
Describe "Invoke-WingetCpp20152019RedistX64" {
    BeforeAll {
        ...
        $scriptRelPath = Join-Path 'scripts/endpoints/remediation/winget' `
            'runtimes/Cpp2015-2019Redist-x64/Invoke-WingetCpp20152019RedistX64.ps1'
    ...
    Context "Help & Metadata" {
        It "Declares required .NOTES fields with Version 1.0.0 and Date 2026-08-23" {
            ...
            $raw | Should -Match 'File Name:\s*Invoke-WingetCpp20152019RedistX64.ps1'
