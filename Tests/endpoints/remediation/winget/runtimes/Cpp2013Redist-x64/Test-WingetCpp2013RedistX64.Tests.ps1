...
Describe "Test-WingetCpp2013RedistX64" {
    BeforeAll {
        ...
        $scriptRelPath = Join-Path 'scripts/endpoints/remediation/winget' `
            'runtimes/Cpp2013Redist-x64/Test-WingetCpp2013RedistX64.ps1'
    ...
    Context "Help & Metadata" {
        It "Declares required .NOTES fields with Version 1.0.0 and Date 2026-08-23" {
            ...
            $raw | Should -Match 'File Name:\s*Test-WingetCpp2013RedistX64.ps1'
