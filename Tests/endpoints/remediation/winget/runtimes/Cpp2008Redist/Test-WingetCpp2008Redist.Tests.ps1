...
Describe "Test-WingetCpp2008Redist" {
    BeforeAll {
        ...
        $scriptRelPath = 'scripts/endpoints/remediation/winget/runtimes/Cpp2008Redist/Test-WingetCpp2008Redist.ps1'
        $scriptPath = Join-Path $repoRoot $scriptRelPath
        $packageId = 'Microsoft.VCRedist.2008.x86'
    ...
    Context "Help & Metadata" {
        It "Declares required .NOTES fields with Version 1.0.0 and Date 2026-08-23" {
            ...
            $raw | Should -Match 'File Name:\s*Test-WingetCpp2008Redist\.ps1'
