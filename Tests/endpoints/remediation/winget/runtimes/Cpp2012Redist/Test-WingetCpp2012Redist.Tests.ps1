...
Describe "Test-WingetCpp2012Redist" {
    BeforeAll {
        ...
        $scriptRelPath = 'scripts/endpoints/remediation/winget/runtimes/Cpp2012Redist/Test-WingetCpp2012Redist.ps1'
        $scriptPath = Join-Path $repoRoot $scriptRelPath
        $packageId = 'Microsoft.VCRedist.2012.x64'
    ...
    Context "Help & Metadata" {
        It "Declares required .NOTES fields with Version 1.0.0 and Date 2026-08-23" {
            ...
            $raw | Should -Match 'File Name:\s*Test-WingetCpp2012Redist\.ps1'
    ...
    Context "Behavior" {
        It "Returns 1 when an update is available via the module path" {
            ...
            Mock Get-WinGetPackage {
                [pscustomobject] @{
                    Name                 = 'Microsoft Visual C++ 2012 x64 Redistributable - x64'
        ...
        It "Uses the CLI fallback to report a not-installed package as compliant" {
