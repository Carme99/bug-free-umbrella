...
Describe "Invoke-WingetCpp2012Redist" {
    BeforeAll {
        ...
        $scriptRelPath = 'scripts/endpoints/remediation/winget/runtimes/Cpp2012Redist/Invoke-WingetCpp2012Redist.ps1'
    ...
    Context "Help & Metadata" {
        It "Declares required .NOTES fields with Version 1.0.0 and Date 2026-08-23" {
            ...
            $raw | Should -Match 'File Name:\s*Invoke-WingetCpp2012Redist\.ps1'
