...
Describe "Test-WingetCpp20152019RedistX86" {
    BeforeAll {
        ...
        $scriptRelPath = Join-Path 'scripts/endpoints/remediation/winget' `
            'runtimes/Cpp2015-2019Redist-x86/Test-WingetCpp20152019RedistX86.ps1'
    ...
    Context "Help & Metadata" {
        It "Declares required .NOTES fields with Version 1.0.0 and Date 2026-08-23" {
            ...
            $raw | Should -Match 'File Name:\s*Test-WingetCpp20152019RedistX86.ps1'
