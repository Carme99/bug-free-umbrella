...
Describe "Test-WingetLenovoDockManager" {
    BeforeAll {
        ...
        $scriptRelPath = 'scripts/endpoints/remediation/winget/vendor-specific/LenovoDockManager/Test-WingetLenovoDockManager.ps1'
