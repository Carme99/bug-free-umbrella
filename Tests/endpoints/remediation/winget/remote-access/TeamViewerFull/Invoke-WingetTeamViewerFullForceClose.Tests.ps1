...
Describe "Invoke-WingetTeamViewerFullForceClose" {
    BeforeAll {
        ...
        $scriptRelPath = 'scripts/endpoints/remediation/winget/remote-access/TeamViewerFull/Invoke-WingetTeamViewerFullForceClose.ps1'
