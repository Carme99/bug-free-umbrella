...
Describe "Test-Winget1Password" {
    BeforeAll {
        ...
        $scriptRelPath = 'scripts/endpoints/remediation/winget/security/1Password/Test-Winget1Password.ps1'
    ...
    Context "Help & Metadata" {
        It "Declares required .NOTES fields with Version 1.0.0 and Date 2026-08-23" {
            ...
            $raw | Should -Match 'File Name:\s*Test-Winget1Password\.ps1'
