...
Describe "Test-WingetVLCMediaPlayer" {
    BeforeAll {
        ...
        $scriptRelPath = 'scripts/endpoints/remediation/winget/media/VLCMediaPlayer/Test-WingetVLCMediaPlayer.ps1'
    ...
    Context "Help & Metadata" {
        It "Declares required .NOTES fields with Version 1.0.0 and Date 2026-08-23" {
            ...
            $raw | Should -Match 'File Name:\s*Test-WingetVLCMediaPlayer\.ps1'
