...
Describe 'endpoints/devices/autopatch/V1/UseWUServer/Detect' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../../scripts/endpoints/devices/autopatch/V1/UseWUServer/Detect.ps1'
