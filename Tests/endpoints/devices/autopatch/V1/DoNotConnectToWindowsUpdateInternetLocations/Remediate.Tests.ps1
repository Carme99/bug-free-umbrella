...
Describe 'endpoints/devices/autopatch/V1/DoNotConnectToWindowsUpdateInternetLocations/Remediate' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../../scripts/endpoints/devices/autopatch/V1/DoNotConnectToWindowsUpdateInternetLocations/Remediate.ps1'
