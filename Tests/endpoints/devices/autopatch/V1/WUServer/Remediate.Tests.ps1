...
Describe 'endpoints/devices/autopatch/V1/WUServer/Remediate' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../../scripts/endpoints/devices/autopatch/V1/WUServer/Remediate.ps1'
    ...
    Context 'Behavior' {
        ...
        It 'Removes the policy value when present and returns 0' {
            Mock Get-ItemProperty { [pscustomobject]@{ WUServer = 1 } }
            Mock Remove-ItemProperty { }
            Main | Should -Be 0
