...
Describe 'endpoints/devices/autopatch/V1/NoAutoUpdate/Remediate' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../../scripts/endpoints/devices/autopatch/V1/NoAutoUpdate/Remediate.ps1'
