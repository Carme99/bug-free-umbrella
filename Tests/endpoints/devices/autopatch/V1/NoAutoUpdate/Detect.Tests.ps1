...
Describe 'endpoints/devices/autopatch/V1/NoAutoUpdate/Detect' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../../scripts/endpoints/devices/autopatch/V1/NoAutoUpdate/Detect.ps1'
