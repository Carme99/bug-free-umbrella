...
Describe "detect.ps1" {
    BeforeAll {
        ...
        $scriptPath = Join-Path $repoRoot "scripts/endpoints/devices/winget/runtimes/Cpp2015-2019Redist-x86/detect.ps1"
    ...
    Context "Behavior" {
        It "Forwards to the canonical script and preserves its exit code" {
            ...
            Should -Invoke Invoke-CanonicalScript -Times 1 -Exactly -ParameterFilter {
                $Path -like '*Test-WingetCpp20152019RedistX86.ps1'
            }
        }
