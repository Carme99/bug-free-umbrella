...
Describe "Check-WindowsActivationGracePeriod/detect.ps1 (deprecated shim)" {
    BeforeAll {
        ...
        $prDir = 'scripts/endpoints/devices/proactive-remediations/Check-WindowsActivationGracePeriod'
        $scriptPath = Join-Path $repoRoot (Join-Path $prDir 'detect.ps1')
        $canonicalRepoPath =
