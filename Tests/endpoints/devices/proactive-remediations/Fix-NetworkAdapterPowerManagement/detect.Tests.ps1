...
Describe "Fix-NetworkAdapterPowerManagement/detect.ps1 (deprecated shim)" {
    BeforeAll {
        ...
        $prDir = 'scripts/endpoints/devices/proactive-remediations/Fix-NetworkAdapterPowerManagement'
