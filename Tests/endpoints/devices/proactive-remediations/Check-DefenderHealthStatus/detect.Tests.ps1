...
Describe 'endpoints/devices/proactive-remediations/Check-DefenderHealthStatus/detect' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-DefenderHealthStatus/detect.ps1'
