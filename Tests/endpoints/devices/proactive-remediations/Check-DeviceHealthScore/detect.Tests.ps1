...
Describe 'endpoints/devices/proactive-remediations/Check-DeviceHealthScore/detect' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-DeviceHealthScore/detect.ps1'
