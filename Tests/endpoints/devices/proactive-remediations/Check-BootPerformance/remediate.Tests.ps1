...
Describe 'endpoints/devices/proactive-remediations/Check-BootPerformance/remediate' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-BootPerformance/remediate.ps1'
