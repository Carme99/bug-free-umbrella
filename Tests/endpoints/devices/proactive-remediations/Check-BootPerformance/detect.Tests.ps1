...
Describe 'endpoints/devices/proactive-remediations/Check-BootPerformance/detect' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-BootPerformance/detect.ps1'
