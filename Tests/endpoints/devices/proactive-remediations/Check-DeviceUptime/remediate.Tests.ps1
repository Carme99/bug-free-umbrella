...
Describe 'endpoints/devices/proactive-remediations/Check-DeviceUptime/remediate' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-DeviceUptime/remediate.ps1'
