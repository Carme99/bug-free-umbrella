...
Describe 'endpoints/devices/proactive-remediations/Check-DeviceUptime/detect' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-DeviceUptime/detect.ps1'
