...
Describe 'endpoints/devices/proactive-remediations/Check-ApplicationCrashes/detect' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-ApplicationCrashes/detect.ps1'
