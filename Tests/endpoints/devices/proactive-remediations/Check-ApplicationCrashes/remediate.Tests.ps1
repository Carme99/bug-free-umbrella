...
Describe 'endpoints/devices/proactive-remediations/Check-ApplicationCrashes/remediate' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-ApplicationCrashes/remediate.ps1'
