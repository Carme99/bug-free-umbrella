...
Describe 'endpoints/devices/proactive-remediations/Check-BatteryHealth/detect' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-BatteryHealth/detect.ps1'
