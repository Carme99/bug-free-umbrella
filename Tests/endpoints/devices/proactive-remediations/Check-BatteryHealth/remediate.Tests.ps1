...
Describe 'endpoints/devices/proactive-remediations/Check-BatteryHealth/remediate' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-BatteryHealth/remediate.ps1'
