...
Describe "remediate.ps1" {
    BeforeAll {
        ...
        $scriptRel = 'scripts/endpoints/devices/proactive-remediations/Fix-WindowsUpdateRebootPending/remediate.ps1'
    ...
    Context "Behavior" {
        It "Forwards to the canonical script and preserves its exit code" {
            ...
            Should -Invoke Invoke-CanonicalScript -Times 1 -Exactly -ParameterFilter {
                $Path -like '*Invoke-RemediationFixWindowsUpdateRebootPending.ps1'
            }
        }
