...
Describe "detect.ps1" {
    BeforeAll {
        ...
        $scriptRel = 'scripts/endpoints/devices/proactive-remediations/Fix-WindowsUpdateRebootPending/detect.ps1'
    ...
    Context "Behavior" {
        It "Forwards to the canonical script and preserves its exit code" {
            ...
            Should -Invoke Invoke-CanonicalScript -Times 1 -Exactly -ParameterFilter {
                $Path -like '*Test-RemediationFixWindowsUpdateRebootPending.ps1'
            }
        }
