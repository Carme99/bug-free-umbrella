...
Describe 'endpoints/devices/proactive-remediations/Check-MicrosoftStoreAppsHealth/remediate' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-MicrosoftStoreAppsHealth/remediate.ps1'
