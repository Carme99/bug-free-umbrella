...
Describe 'endpoints/devices/proactive-remediations/Check-MicrosoftStoreAppsHealth/detect' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-MicrosoftStoreAppsHealth/detect.ps1'
