...
Describe 'endpoints/devices/proactive-remediations/Check-MemoryDiagnostics/remediate' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-MemoryDiagnostics/remediate.ps1'
