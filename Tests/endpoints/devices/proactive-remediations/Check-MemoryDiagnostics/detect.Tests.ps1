...
Describe 'endpoints/devices/proactive-remediations/Check-MemoryDiagnostics/detect' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-MemoryDiagnostics/detect.ps1'
