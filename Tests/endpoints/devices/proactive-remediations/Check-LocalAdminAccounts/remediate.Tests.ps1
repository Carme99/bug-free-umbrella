...
Describe 'endpoints/devices/proactive-remediations/Check-LocalAdminAccounts/remediate' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-LocalAdminAccounts/remediate.ps1'
