...
Describe 'endpoints/devices/proactive-remediations/Check-LocalAdminAccounts/detect' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-LocalAdminAccounts/detect.ps1'
