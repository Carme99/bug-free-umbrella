...
Describe 'endpoints/devices/proactive-remediations/Check-OutdatedCriticalApps/remediate' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-OutdatedCriticalApps/remediate.ps1'
