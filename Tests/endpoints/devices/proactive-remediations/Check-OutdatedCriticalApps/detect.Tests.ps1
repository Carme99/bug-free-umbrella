...
Describe 'endpoints/devices/proactive-remediations/Check-OutdatedCriticalApps/detect' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-OutdatedCriticalApps/detect.ps1'
