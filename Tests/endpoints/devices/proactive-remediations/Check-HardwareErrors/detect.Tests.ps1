...
Describe 'endpoints/devices/proactive-remediations/Check-HardwareErrors/detect' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-HardwareErrors/detect.ps1'
