...
Describe 'endpoints/devices/proactive-remediations/Check-DiskHealth/detect' {
    BeforeAll {
        $scriptPath = Join-Path $PSScriptRoot '../../../../../scripts/endpoints/devices/proactive-remediations/Check-DiskHealth/detect.ps1'
