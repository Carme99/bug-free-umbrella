...
All scripts are located in: `/scripts/security/`
...
|--------|-------------|----------|
| **Test-CISBenchmark.ps1** | CIS Benchmark compliance testing for Windows Server | `scripts/security/compliance/frameworks/` |
| **Test-SecurityFeatures.ps1** | Validate Windows security features configuration | `scripts/security/compliance/frameworks/` |
| **Get-SecurityBaseline.ps1** | Retrieve and compare security baseline settings | `scripts/security/compliance/frameworks/` |
| **Get-AntivirusStatus.ps1** | Audit antivirus installation and update status | `scripts/security/compliance/frameworks/` |
| **Get-LocalAdminAudit.ps1** | Audit local administrator group membership | `scripts/security/compliance/frameworks/` |
| **Get-FailedLoginReport.ps1** | Generate report of failed login attempts | `scripts/security/compliance/frameworks/` |
| **Get-USBDeviceAudit.ps1** | Track USB device connections and usage | `scripts/security/compliance/frameworks/` |
| **Get-ExpiredCertificates.ps1** | Find expired or expiring certificates | `scripts/security/compliance/frameworks/` |
| **Get-OpenPortScan.ps1** | Scan for open network ports and services | `scripts/security/compliance/frameworks/` |
| **Get-SoftwareLicenseCompliance.ps1** | Audit software license compliance | `scripts/security/compliance/frameworks/` |
...
| Script | Description | Location |
|--------|-------------|----------|
| **Get-MDEDeviceHealth.ps1** | Retrieve MDE device health and onboarding status | `scripts/security/compliance/defender-endpoint/` |
...
| Script | Description | Location |
|--------|-------------|----------|
| **Invoke-SecurityComplianceScan.ps1** | Comprehensive security compliance scanning | `scripts/security/hardening/` |
...
| Script | Description | Location |
|--------|-------------|----------|
| **Get-SystemHealthCheck.ps1** | Comprehensive system health assessment | `scripts/security/monitoring/` |
| **Get-BatteryHealth.ps1** | Monitor battery health and performance | `scripts/security/monitoring/` |
| **Get-PerformanceTrends.ps1** | Track system performance trends over time | `scripts/security/monitoring/` |
| **Get-SystemResourceTrends.ps1** | Monitor CPU, memory, and disk trends | `scripts/security/monitoring/` |
...
- **[Intune Management](Intune-Management)** - Deploy security scripts via Intune
- **[Server Management](Server-Management)** - Server-specific security scripts
- **[FAQ](FAQ)** - Common questions and answers

### External Resources
- **[CIS Benchmarks](https://www.cisecurity.org/cis-benchmarks/)** - Industry security standards
- **[Microsoft Security Baselines](https://docs.microsoft.com/en-us/windows/security/threat-protection/windows-security-baselines)** - Microsoft recommended settings
