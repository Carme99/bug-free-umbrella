...
- 🔄 IAM Resource Audit (Coming Soon)
- 🔄 Cost & Billing Analysis (Coming Soon)
...
[View Full Script →](https://github.com/Carme99/bug-free-umbrella/blob/main/scripts/cloud/aws/core/Get-AWSResourceInventory.ps1)
...
- 📖 [Cloud Management Overview](https://github.com/Carme99/bug-free-umbrella/tree/main/scripts/cloud)
- 📖 [Common Use Cases](Common-Use-Cases)
