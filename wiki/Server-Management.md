...
All scripts are located in: `/scripts/infrastructure/windows/`
...
### External Resources
- **[Windows Server Documentation](https://docs.microsoft.com/en-us/windows-server/)** - Official Microsoft docs
- **[Active Directory Best Practices](https://docs.microsoft.com/en-us/windows-server/identity/ad-ds/plan/security-best-practices/best-practices-for-securing-active-directory)** - AD security guidance
