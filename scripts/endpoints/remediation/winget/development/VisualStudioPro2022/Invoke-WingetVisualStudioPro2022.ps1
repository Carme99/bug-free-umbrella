<#
.SYNOPSIS
Updates Visual Studio Professional 2022 (winget id Microsoft.VisualStudio.2022.Professional) silently for Intune
    Proactive Remediations.

.DESCRIPTION
    Remediation half of the Visual Studio Professional 2022 update pair. Prefers the Microsoft.WinGet.Client PowerShell
    ...
    If the Visual Studio Professional 2022 process is running, the update is deferred (exit 1) so Intune retries later.
    Exit codes:
...
.EXAMPLE
    ...
    Updates Visual Studio Professional 2022 silently; exits 0 on success or when already up to date.

.EXAMPLE
    PS C:\> .\Invoke-WingetVisualStudioPro2022.ps1 -WhatIf
