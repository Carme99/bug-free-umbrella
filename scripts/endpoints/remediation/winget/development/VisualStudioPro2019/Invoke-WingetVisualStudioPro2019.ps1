<#
.SYNOPSIS
Updates Visual Studio Professional 2019 (winget id Microsoft.VisualStudio.2019.Professional) silently for Intune
    Proactive Remediations.

.DESCRIPTION
    Remediation half of the Visual Studio Professional 2019 update pair. Prefers the Microsoft.WinGet.Client PowerShell
    ...
    If the Visual Studio Professional 2019 process is running, the update is deferred (exit 1) so Intune retries later.
    Exit codes:
...
.NOTES
    File Name: Invoke-WingetVisualStudioPro2019.ps1
...
.EXAMPLE
    PS C:\> .\Invoke-WingetVisualStudioPro2019.ps1
    Updates Visual Studio Professional 2019 silently; exits 0 on success or when already up to date.

.EXAMPLE
    PS C:\> .\Invoke-WingetVisualStudioPro2019.ps1 -WhatIf
