<#
.SYNOPSIS
Detects pending updates for Visual Studio Professional 2019 (winget id Microsoft.VisualStudio.2019.Professional)
    for Intune Proactive Remediations.

.DESCRIPTION
    Detection half of the Visual Studio Professional 2019 update pair. Prefers the Microsoft.WinGet.Client PowerShell
    ...
    Exit codes:
- 0: compliant - Visual Studio Professional 2019 is up to date, not installed, or the check could not run (network
    down,
...
.EXAMPLE
    PS C:\> .\Test-WingetVisualStudioPro2019.ps1
Runs the detection check and exits 0 when Visual Studio Professional 2019 is up to date or absent, 1 when an
    update is available.

.EXAMPLE
    PS C:\> & 'C:\Program Files\...\Test-WingetVisualStudioPro2019.ps1'
