<#
.SYNOPSIS
    Detects pending updates for the C++ 2008 Redistributable (Microsoft.VCRedist.2012.x64).
...
.NOTES
    File Name: Test-WingetCpp2012Redist.ps1
