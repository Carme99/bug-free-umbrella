<#
.SYNOPSIS
    Detects pending updates for the C++ 2008 Redistributable (Microsoft.VCRedist.2008.x86).
...
.NOTES
    File Name: Test-WingetCpp2008Redist.ps1
