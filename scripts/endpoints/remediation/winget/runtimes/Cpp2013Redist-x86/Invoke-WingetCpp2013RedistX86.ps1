<#
.SYNOPSIS
    Silently updates the Visual C++ Redistributable package Microsoft.VCRedist.2013.x86 for Intune remediations.

.DESCRIPTION
    Remediation half of the Visual C++ Redistributable update pair. Checks whether an update is available
    for winget package Microsoft.VCRedist.2013.x86 and installs it silently. When the redistributable installer process
...
.NOTES
    File Name: Invoke-WingetCpp2013RedistX86.ps1
...
.EXAMPLE
    PS C:\> .\Invoke-WingetCpp2013RedistX86.ps1
    Updates Microsoft.VCRedist.2013.x86 silently; exits 0 on success or when already up to date.

.EXAMPLE
    PS C:\> .\Invoke-WingetCpp2013RedistX86.ps1 -WhatIf
...
$AppProcess = 'Microsoft.VCRedist.2013.x86'
$MaxRetries = 3
$VerifyWaitSeconds = 5
$EnableLogging = $false
