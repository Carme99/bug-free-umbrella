...
.NOTES
    File Name: Test-WingetCpp20152019RedistX64.ps1
...
.EXAMPLE
    PS C:\> .\Test-WingetCpp20152019RedistX64.ps1
    Runs the detection check; exits 0 when up to date or absent, 1 when an update is available.

.EXAMPLE
    PS C:\> & 'C:\Program Files\IntuneScripts\Test-WingetCpp20152019RedistX64.ps1'
