<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/security/Test-RemediationCheckDefenderHealthStatus.ps1
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/security/Test-RemediationCheckDefenderHealthStatus.ps1.
...
$canonicalScript = Join-Path $PSScriptRoot '../../../remediation/security/Test-RemediationCheckDefenderHealthStatus.ps1'
$forwardArgs = $args
