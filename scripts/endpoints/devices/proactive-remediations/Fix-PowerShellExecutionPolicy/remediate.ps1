<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/security/Invoke-RemediationFixPowerShellExecutionPolicy.ps1.
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/security/Invoke-RemediationFixPowerShellExecutionPolicy.ps1
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/security/Invoke-RemediationFixPowerShellExecutionPolicy.ps1'
        $targetRel = '../../../remediation/security/Invoke-RemediationFixPowerShellExecutionPolicy.ps1'
