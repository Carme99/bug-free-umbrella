<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/security/Invoke-RemediationCheckLocalAdminAccounts.ps1
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/security/Invoke-RemediationCheckLocalAdminAccounts.ps1.
...
$canonicalScript = Join-Path $PSScriptRoot '../../../remediation/security/Invoke-RemediationCheckLocalAdminAccounts.ps1'
$forwardArgs = $args
