<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/security/Test-RemediationCheckLocalAdminAccounts.ps1
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/security/Test-RemediationCheckLocalAdminAccounts.ps1.
