<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Test-RemediationFixTempFiles.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/system/Test-RemediationFixTempFiles.ps1'
