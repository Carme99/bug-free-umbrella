<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system

.DESCRIPTION
    Deprecated compatibility shim retained so existing Intune Proactive Remediation assignments keep working.
    Forwards execution, arguments, and exit code to the canonical script at scripts/endpoints/remediation/system.
...
$canonicalScript = Join-Path $PSScriptRoot '../../../remediation/system/Test-RemediationCheckMicrosoftStoreAppsHealth.ps1'
