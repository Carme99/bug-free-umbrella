<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system/Test-RemediationFixStaleProfiles.ps1.
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/system/Test-RemediationFixStaleProfiles.ps1'
        $targetRel = '../../../remediation/system/Test-RemediationFixStaleProfiles.ps1'
