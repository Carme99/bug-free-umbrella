<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Test-RemediationFixWindowsStoreLicensing.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/system/Test-RemediationFixWindowsStoreLicensing.ps1'
