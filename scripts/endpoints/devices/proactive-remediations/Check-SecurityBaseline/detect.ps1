<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/security/Test-RemediationCheckSecurityBaseline.ps1.
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/security/Test-RemediationCheckSecurityBaseline.ps1
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/security/Test-RemediationCheckSecurityBaseline.ps1'
        $targetRel = '../../../remediation/security/Test-RemediationCheckSecurityBaseline.ps1'
