<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Test-RemediationFixTimeSync.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/system/Test-RemediationFixTimeSync.ps1'
