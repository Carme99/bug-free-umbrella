<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/network/Invoke-RemediationCheckSharedFolders.ps1.
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/network/Invoke-RemediationCheckSharedFolders.ps1'
        $targetRel = '../../../remediation/network/Invoke-RemediationCheckSharedFolders.ps1'
