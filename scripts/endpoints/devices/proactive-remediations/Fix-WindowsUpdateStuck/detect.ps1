<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Test-RemediationFixWindowsUpdateStuck.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/system/Test-RemediationFixWindowsUpdateStuck.ps1'
