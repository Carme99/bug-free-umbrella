<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system/Test-RemediationCheckHardwareErrors.ps1
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/system/Test-RemediationCheckHardwareErrors.ps1.
...
$canonicalScript = Join-Path $PSScriptRoot '../../../remediation/system/Test-RemediationCheckHardwareErrors.ps1'
$forwardArgs = $args
