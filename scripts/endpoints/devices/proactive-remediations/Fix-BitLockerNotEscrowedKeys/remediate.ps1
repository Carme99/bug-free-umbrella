<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/security/Invoke-RemediationFixBitLockerNotEscrowedKeys.ps1.
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/security/Invoke-RemediationFixBitLockerNotEscrowedKeys.ps1
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/security/Invoke-RemediationFixBitLockerNotEscrowedKeys.ps1'
        $targetRel = '../../../remediation/security/Invoke-RemediationFixBitLockerNotEscrowedKeys.ps1'
