<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/security/Test-RemediationFixBitLockerNotEscrowedKeys.ps1.
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/security/Test-RemediationFixBitLockerNotEscrowedKeys.ps1
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/security/Test-RemediationFixBitLockerNotEscrowedKeys.ps1'
        $targetRel = '../../../remediation/security/Test-RemediationFixBitLockerNotEscrowedKeys.ps1'
