<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system/Test-RemediationCheckServiceFailures.ps1.
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/system/Test-RemediationCheckServiceFailures.ps1
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/system/Test-RemediationCheckServiceFailures.ps1'
        $targetRel = '../../../remediation/system/Test-RemediationCheckServiceFailures.ps1'
