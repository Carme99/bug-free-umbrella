<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system/Test-RemediationFixSystemFileCorruption.ps1.
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/system/Test-RemediationFixSystemFileCorruption.ps1
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/system/Test-RemediationFixSystemFileCorruption.ps1'
        $targetRel = '../../../remediation/system/Test-RemediationFixSystemFileCorruption.ps1'
