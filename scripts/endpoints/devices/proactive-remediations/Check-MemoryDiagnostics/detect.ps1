<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system/Test-RemediationCheckMemoryDiagnostics.ps1
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/system/Test-RemediationCheckMemoryDiagnostics.ps1.
...
$canonicalScript = Join-Path $PSScriptRoot '../../../remediation/system/Test-RemediationCheckMemoryDiagnostics.ps1'
$forwardArgs = $args
