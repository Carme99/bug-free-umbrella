<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system/Invoke-RemediationCheckMemoryDiagnostics.ps1
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/system/Invoke-RemediationCheckMemoryDiagnostics.ps1.
...
$canonicalScript = Join-Path $PSScriptRoot '../../../remediation/system/Invoke-RemediationCheckMemoryDiagnostics.ps1'
$forwardArgs = $args
