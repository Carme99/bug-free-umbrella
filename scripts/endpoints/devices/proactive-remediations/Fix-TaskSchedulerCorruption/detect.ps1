<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system/Test-RemediationFixTaskSchedulerCorruption.ps1.
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/system/Test-RemediationFixTaskSchedulerCorruption.ps1
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/system/Test-RemediationFixTaskSchedulerCorruption.ps1'
        $targetRel = '../../../remediation/system/Test-RemediationFixTaskSchedulerCorruption.ps1'
