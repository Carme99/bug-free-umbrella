<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system/Test-RemediationFixCredentialManager.ps1.
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/system/Test-RemediationFixCredentialManager.ps1
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/system/Test-RemediationFixCredentialManager.ps1'
        $targetRel = '../../../remediation/system/Test-RemediationFixCredentialManager.ps1'
