<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system/Invoke-RemediationFixCredentialManager.ps1.
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/system/Invoke-RemediationFixCredentialManager.ps1
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/system/Invoke-RemediationFixCredentialManager.ps1'
        $targetRel = '../../../remediation/system/Invoke-RemediationFixCredentialManager.ps1'
