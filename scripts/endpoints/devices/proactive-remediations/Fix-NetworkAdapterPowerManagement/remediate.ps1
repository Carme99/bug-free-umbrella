<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/network/Invoke-RemediationFixNetworkAdapterPowerManagement.ps1.
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/network/Invoke-RemediationFixNetworkAdapterPowerManagement.ps1
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/network/Invoke-RemediationFixNetworkAdapterPowerManagement.ps1'
        $targetRel = '../../../remediation/network/Invoke-RemediationFixNetworkAdapterPowerManagement.ps1'
