<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/network/Test-RemediationFixNetworkAdapterPowerManagement.ps1.
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/network/Test-RemediationFixNetworkAdapterPowerManagement.ps1
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/network/Test-RemediationFixNetworkAdapterPowerManagement.ps1'
        $targetRel = '../../../remediation/network/Test-RemediationFixNetworkAdapterPowerManagement.ps1'
