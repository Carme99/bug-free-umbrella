<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system/Invoke-RemediationCheckApplicationCrashes.ps1
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/system/Invoke-RemediationCheckApplicationCrashes.ps1.
...
$canonicalScript = Join-Path $PSScriptRoot '../../../remediation/system/Invoke-RemediationCheckApplicationCrashes.ps1'
$forwardArgs = $args
