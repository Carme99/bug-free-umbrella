<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system/Test-RemediationCheckApplicationCrashes.ps1
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/system/Test-RemediationCheckApplicationCrashes.ps1.
...
$canonicalScript = Join-Path $PSScriptRoot '../../../remediation/system/Test-RemediationCheckApplicationCrashes.ps1'
$forwardArgs = $args
