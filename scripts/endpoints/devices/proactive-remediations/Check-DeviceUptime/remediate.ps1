<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system/Invoke-RemediationCheckDeviceUptime.ps1
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/system/Invoke-RemediationCheckDeviceUptime.ps1.
...
$canonicalScript = Join-Path $PSScriptRoot '../../../remediation/system/Invoke-RemediationCheckDeviceUptime.ps1'
$forwardArgs = $args
