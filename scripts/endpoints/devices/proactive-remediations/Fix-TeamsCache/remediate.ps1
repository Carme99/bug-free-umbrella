<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Invoke-RemediationFixTeamsCache.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/system/Invoke-RemediationFixTeamsCache.ps1'
