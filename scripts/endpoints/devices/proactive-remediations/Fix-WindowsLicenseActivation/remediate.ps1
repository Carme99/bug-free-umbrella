<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Invoke-RemediationFixWindowsLicenseActivation.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/system/Invoke-RemediationFixWindowsLicenseActivation.ps1'
