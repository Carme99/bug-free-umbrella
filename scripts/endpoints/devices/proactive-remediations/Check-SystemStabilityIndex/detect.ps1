<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system/Test-RemediationCheckSystemStabilityIndex.ps1.
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/system/Test-RemediationCheckSystemStabilityIndex.ps1
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/system/Test-RemediationCheckSystemStabilityIndex.ps1'
        $targetRel = '../../../remediation/system/Test-RemediationCheckSystemStabilityIndex.ps1'
