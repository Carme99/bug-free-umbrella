<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system/Invoke-RemediationCheckSystemStabilityIndex.ps1.
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/system/Invoke-RemediationCheckSystemStabilityIndex.ps1
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/system/Invoke-RemediationCheckSystemStabilityIndex.ps1'
        $targetRel = '../../../remediation/system/Invoke-RemediationCheckSystemStabilityIndex.ps1'
