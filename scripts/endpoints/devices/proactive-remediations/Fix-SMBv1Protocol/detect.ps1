<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/network/Test-RemediationFixSMBv1Protocol.ps1.
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/network/Test-RemediationFixSMBv1Protocol.ps1
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/network/Test-RemediationFixSMBv1Protocol.ps1'
        $targetRel = '../../../remediation/network/Test-RemediationFixSMBv1Protocol.ps1'
