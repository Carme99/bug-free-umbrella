<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/network/Invoke-RemediationFixSMBv1Protocol.ps1.
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/network/Invoke-RemediationFixSMBv1Protocol.ps1
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/network/Invoke-RemediationFixSMBv1Protocol.ps1'
        $targetRel = '../../../remediation/network/Invoke-RemediationFixSMBv1Protocol.ps1'
