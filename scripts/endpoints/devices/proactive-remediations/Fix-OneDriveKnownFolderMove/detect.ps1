<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system/Test-RemediationFixOneDriveKnownFolderMove.ps1.
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/system/Test-RemediationFixOneDriveKnownFolderMove.ps1
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/system/Test-RemediationFixOneDriveKnownFolderMove.ps1'
        $targetRel = '../../../remediation/system/Test-RemediationFixOneDriveKnownFolderMove.ps1'
