<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system/Invoke-RemediationCheckDiskHealth.ps1
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/system/Invoke-RemediationCheckDiskHealth.ps1.
...
$canonicalScript = Join-Path $PSScriptRoot '../../../remediation/system/Invoke-RemediationCheckDiskHealth.ps1'
$forwardArgs = $args
