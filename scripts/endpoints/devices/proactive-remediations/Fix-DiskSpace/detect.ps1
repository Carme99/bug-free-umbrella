<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system/Test-RemediationFixDiskSpace.ps1.
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/system/Test-RemediationFixDiskSpace.ps1'
        $targetRel = '../../../remediation/system/Test-RemediationFixDiskSpace.ps1'
