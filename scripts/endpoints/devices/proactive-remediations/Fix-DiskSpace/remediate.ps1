<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system/Invoke-RemediationFixDiskSpace.ps1.
...
function Main {
    try {
        $movedTo = 'scripts/endpoints/remediation/system/Invoke-RemediationFixDiskSpace.ps1'
        $targetRel = '../../../remediation/system/Invoke-RemediationFixDiskSpace.ps1'
