<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Test-RemediationKeyboardLayout.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/system/Test-RemediationKeyboardLayout.ps1'
