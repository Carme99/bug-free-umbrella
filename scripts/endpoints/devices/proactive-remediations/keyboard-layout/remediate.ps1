<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Invoke-RemediationKeyboardLayout.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/system/Invoke-RemediationKeyboardLayout.ps1'
