<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Test-RemediationLanguagePackAudit.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/system/Test-RemediationLanguagePackAudit.ps1'
