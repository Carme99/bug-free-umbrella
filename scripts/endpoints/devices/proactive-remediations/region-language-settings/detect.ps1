<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Test-RemediationRegionLanguageSettings.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/system/Test-RemediationRegionLanguageSettings.ps1'
