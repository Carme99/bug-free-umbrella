<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Invoke-RemediationRegionLanguageSettings.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/system/Invoke-RemediationRegionLanguageSettings.ps1'
