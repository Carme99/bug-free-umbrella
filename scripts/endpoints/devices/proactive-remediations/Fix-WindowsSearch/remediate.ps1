<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Invoke-RemediationFixWindowsSearch.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/system/Invoke-RemediationFixWindowsSearch.ps1'
