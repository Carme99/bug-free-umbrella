<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Test-RemediationFixWindowsSearch.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/system/Test-RemediationFixWindowsSearch.ps1'
