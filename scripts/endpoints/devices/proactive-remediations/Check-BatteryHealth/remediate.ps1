<#
.SYNOPSIS
    DEPRECATED: use scripts/endpoints/remediation/system/Invoke-RemediationCheckBatteryHealth.ps1
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/system/Invoke-RemediationCheckBatteryHealth.ps1.
...
$canonicalScript = Join-Path $PSScriptRoot '../../../remediation/system/Invoke-RemediationCheckBatteryHealth.ps1'
$forwardArgs = $args
