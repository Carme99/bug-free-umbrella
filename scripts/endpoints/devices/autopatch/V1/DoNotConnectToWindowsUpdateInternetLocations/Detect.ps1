...
.DESCRIPTION
    Exits 1 when the DoNotConnectToWindowsUpdateInternetLocations value is present under
    HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate so the paired remediation removes it; exits 0 when
