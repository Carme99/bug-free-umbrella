...
.DESCRIPTION
    Removes the Windows Update policies DoNotConnectToWindowsUpdateInternetLocations and NoAutoUpdate from the
    registry so devices return to default Windows Update behaviour.
