<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Test-WingetCpp2012Redist.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/winget/runtimes/Cpp2012Redist/Test-WingetCpp2012Redist.ps1'
