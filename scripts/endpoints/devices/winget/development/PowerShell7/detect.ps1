<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Test-WingetPowerShell7.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/winget/development/PowerShell7/Test-WingetPowerShell7.ps1'
