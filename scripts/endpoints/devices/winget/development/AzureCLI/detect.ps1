<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Test-WingetAzureCLI.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/winget/development/AzureCLI/Test-WingetAzureCLI.ps1'
