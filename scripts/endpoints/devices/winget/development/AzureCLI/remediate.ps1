<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Invoke-WingetAzureCLI.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/winget/development/AzureCLI/Invoke-WingetAzureCLI.ps1'
