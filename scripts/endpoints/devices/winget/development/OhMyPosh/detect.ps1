<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Test-WingetOhMyPosh.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/winget/development/OhMyPosh/Test-WingetOhMyPosh.ps1'
