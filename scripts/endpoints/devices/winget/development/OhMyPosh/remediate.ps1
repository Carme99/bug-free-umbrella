<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Invoke-WingetOhMyPosh.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/winget/development/OhMyPosh/Invoke-WingetOhMyPosh.ps1'
