<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Test-WingetVisualStudioPro2019.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/winget/development/VisualStudioPro2019/Test-WingetVisualStudioPro2019.ps1'
