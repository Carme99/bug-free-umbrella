<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Invoke-WingetVisualStudioPro2019.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/winget/development/VisualStudioPro2019/Invoke-WingetVisualStudioPro2019.ps1'
