<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Test-WingetVisualStudioPro2022.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/winget/development/VisualStudioPro2022/Test-WingetVisualStudioPro2022.ps1'
