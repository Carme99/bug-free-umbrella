<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Invoke-WingetVisualStudioPro2022.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/winget/development/VisualStudioPro2022/Invoke-WingetVisualStudioPro2022.ps1'
