<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Test-WingetVisualStudioCode.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/winget/development/VisualStudioCode/Test-WingetVisualStudioCode.ps1'
