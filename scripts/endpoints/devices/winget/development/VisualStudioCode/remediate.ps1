<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Invoke-WingetVisualStudioCode.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/winget/development/VisualStudioCode/Invoke-WingetVisualStudioCode.ps1'
