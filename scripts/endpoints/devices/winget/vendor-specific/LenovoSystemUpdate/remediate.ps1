<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Invoke-WingetLenovoSystemUpdate.ps1.
...
.DESCRIPTION
    ...
    scripts/endpoints/remediation/winget/vendor-specific/LenovoSystemUpdate/Invoke-WingetLenovoSystemUpdate.ps1
    ...
    compliant/remediation succeeded, 1 = needs remediation or remediation failed).
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/winget/vendor-specific/LenovoSystemUpdate/Invoke-WingetLenovoSystemUpdate.ps1'
