<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Invoke-WingetSlack.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/winget/communication/Slack/Invoke-WingetSlack.ps1'
