<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Invoke-WingetDiscord.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/winget/communication/Discord/Invoke-WingetDiscord.ps1'
