<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Test-WingetDiscord.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/winget/communication/Discord/Test-WingetDiscord.ps1'
