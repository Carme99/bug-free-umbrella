<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Invoke-WingetGoogleChrome.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/winget/browsers/GoogleChrome/Invoke-WingetGoogleChrome.ps1'
