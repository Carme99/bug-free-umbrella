<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Test-WingetGoogleChrome.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/winget/browsers/GoogleChrome/Test-WingetGoogleChrome.ps1'
