<#
.SYNOPSIS
    [DEPRECATED] Forward to the canonical remediation script Invoke-WingetFirefox.ps1.
...
function Main {
    try {
        ...
        $canonicalFile = 'remediation/winget/browsers/Firefox/Invoke-WingetFirefox.ps1'
