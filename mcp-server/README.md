...
> **AI-native script discovery** — every one of the 381 catalogued PowerShell scripts in this repo is now a tool your AI assistant can search, preview, and validate.

## Why MCP?

Bug-Free Umbrella has 381 catalogued scripts across 8 domains. Finding the right one by browsing folders is slow. The MCP server puts the entire catalog behind a standard [Model Context Protocol](https://modelcontextprotocol.io) interface so Claude, Cursor, or Windsurf can answer:
