...
Five quick recipes for the `BugFreeUmbrella` module (PowerShell 7+). Import once per session, then drive the catalogued scripts from the command line.
...
See [docs/Getting-Started.md](../../docs/Getting-Started.md) for the full tour and [docs/Script-Catalog.md](../../docs/Script-Catalog.md) for the catalogued script index.
