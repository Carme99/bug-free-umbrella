...
### 🚀 [New-AzureComputeGalleryImage.ps1](Azure-Compute-Gallery-Image-Builder.md)
...
**[Full Documentation →](Azure-Compute-Gallery-Image-Builder.md)**
...
|----------|-------------|
| [ACG Image Builder Guide](Azure-Compute-Gallery-Image-Builder.md) | Complete documentation for New-AzureComputeGalleryImage.ps1 |
| [scripts/cloud/azure/avd](../scripts/cloud/azure/avd/README.md) | Source code and scripts |
...
- [AVD Image Management Best Practices](https://learn.microsoft.com/azure/virtual-desktop/set-up-customize-master-image)
