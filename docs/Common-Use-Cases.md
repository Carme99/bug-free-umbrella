...
**Documentation:** [Proactive Remediations](Proactive-Remediations.md)
...
**Documentation:** [Script Examples](Script-Examples.md#bitlocker)
...
**Documentation:** [Script Catalog](Script-Catalog.md#device-cleanup)
...
**Documentation:** [Security & Compliance](Security-Compliance.md)
...
**Documentation:** [Security & Compliance](Security-Compliance.md#auditing)
...
**Documentation:** [Azure Virtual Desktop](Azure-Virtual-Desktop.md) | [ACG Image Builder](Azure-Compute-Gallery-Image-Builder.md)
...
- **`scripts/cloud/azure/compute/Azure-VirtualMachines/Get-VMBackupCompliance.ps1`** - Check VM backups
- **`scripts/cloud/azure/compute/Azure-VirtualMachines/Get-VMSecurityConfig.ps1`** - Audit VM security

**Documentation:** [Script Catalog](Script-Catalog.md) (see the Cloud Management section)
...
**Solutions:**
- **`scripts/cloud/azure/compute/Azure-VirtualMachines/Optimize-AzureVMs.ps1`** - Optimize Azure VMs
...
**Documentation:** [Microsoft 365 Cloud Services](Microsoft-365-Cloud-Services.md)
...
**Documentation:** [Microsoft 365 Cloud Services](Microsoft-365-Cloud-Services.md#azure-ad)
...
- **`scripts/collaboration/microsoft365/sharepoint-onedrive/Set-SiteRegionalSettings.ps1`** - Set SharePoint region
- **`scripts/collaboration/microsoft365/teams/Set-TeamsRegionalSettings.ps1`** - Set Teams region

**Documentation:** [Microsoft 365 Cloud Services](Microsoft-365-Cloud-Services.md#regional-settings)
...
**Documentation:** [Server Management](Server-Management.md)
...
**Documentation:** [Server Management](Server-Management.md#active-directory)
...
**Documentation:** [Script Catalog](Script-Catalog.md) (see the Web Services section)
...
**Documentation:** [Intune Management](Intune-Management.md)
...
**Documentation:** [Intune Management](Intune-Management.md#reporting)
...
**Documentation:** [Script Catalog](Script-Catalog.md) (see the Database Management section)
...
**Documentation:** [Script Catalog](Script-Catalog.md) (see the Automation & DevOps section)
...
**Documentation:** [Script Catalog](Script-Catalog.md) (see the Infrastructure as Code section)
...
**Documentation:** [Script Catalog](Script-Catalog.md) (see the Container Management section)
...
- **[Workflows](Workflows.md)** - Complete step-by-step guides
- **[Azure Virtual Desktop](Azure-Virtual-Desktop.md)** - AVD deployment workflow
- **[Azure Compute Gallery Image Builder](Azure-Compute-Gallery-Image-Builder.md)** - ACG image creation workflow
...
1. **[Script Catalog](Script-Catalog.md)** - Browse all 566 scripts on disk (381 catalogued) by category
