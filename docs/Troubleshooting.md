...
4. **Report the Issue:**
   - See **[SUPPORT](../SUPPORT.md)** for response time expectations
   - Review **[CODE_OF_CONDUCT](../CODE_OF_CONDUCT.md)** before reporting
...
### Project Resources
- **[SUPPORT](../SUPPORT.md)** - Response times and support channels
