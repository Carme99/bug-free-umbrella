...
This imports the `BugFreeUmbrella` module (v2.0.1, `src/BugFreeUmbrella/`) into your session, prints how many commands it exposes (`Get-BUScript`, `Invoke-BUScript`), and suggests next steps. Re-running is idempotent.
