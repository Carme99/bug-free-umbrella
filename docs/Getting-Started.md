...
This imports the `BugFreeUmbrella` module (v2.0.0, `src/BugFreeUmbrella/`) into your session, prints how many commands it exposes (`Get-BUScript`, `Invoke-BUScript`), and suggests next steps. Re-running is idempotent.

### Launcher CLI v2: `Invoke-Umbrella.ps1`

Discover and run any of the 566 scripts on disk (381 catalogued) without memorizing paths:
...
Try: Get-DeviceComplianceReport.ps1
    ↓
See: [Intune Management](Intune-Management.md) guide
    ↓
Follow: [Monthly Compliance Audit Workflow](Workflows.md#monthly-compliance-audit-workflow)
```

**[Start with Intune Management →](Intune-Management.md)**
...
Try: Monitor-ServerHealth.ps1
    ↓
See: [Server Management](Server-Management.md) guide
    ↓
Follow: [New Server Setup Workflow](Workflows.md#new-windows-server-setup)
```

**[Start with Server Management →](Server-Management.md)**
...
Try: Monitor-AzureDevOpsPipelines.ps1
    ↓
See: Automation & DevOps scripts in the [Script Catalog](Script-Catalog.md)
    ↓
Explore: Cloud Management scripts in the [Script Catalog](Script-Catalog.md)
```

**Start with DevOps & CI/CD** - browse the [Script Catalog](Script-Catalog.md) to explore the automation scripts

### Path 4: IT Support / Help Desk
```
YOU ARE HERE
    ↓
Review [Proactive Remediations](Proactive-Remediations.md)
    ↓
...
2. 📖 Browse [Script Catalog](Script-Catalog.md) to see all scripts
3. 💡 Review [Script Examples](Script-Examples.md) for detailed usage
4. 🛠️ Try a [Workflow](Workflows.md) for a complete process

### Intermediate Path
1. ✅ You're ready for production!
2. 📋 Follow [Complete Workflows](Workflows.md)
3. 🔧 Set up [Automated Winget Updates](Workflows.md#setting-up-automated-winget-updates)
4. 📊 Implement [Monthly Compliance Audit](Workflows.md#monthly-compliance-audit-workflow)
...
### Documentation
- 📖 **Script Examples** - [See detailed examples](Script-Examples.md)
- 🔍 **Troubleshooting** - [Common issues](Troubleshooting.md)
- ❓ **FAQ** - [Frequently asked questions](FAQ.md)
- 📋 **Workflows** - [Complete processes](Workflows.md)

### Support
| Issue | Where to Go |
|-------|-------------|
| Need support or help | [Support Guide](../SUPPORT.md) - Response times and channels |
| Script not working | [Troubleshooting Guide](Troubleshooting.md) |
| Don't understand usage | [Script Examples](Script-Examples.md) |
...
| Project governance | [Governance](../GOVERNANCE.md) - Solo maintainer model |

**Note:** This is a hobby project. See the [Support Guide](../SUPPORT.md) for response time expectations (typically 1-2 weeks). Issues are automatically labeled and inactive issues/PRs are closed after 60-90 days.
...
**Next:** Choose your path above or browse the [Script Catalog](Script-Catalog.md)
