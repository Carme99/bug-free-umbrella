...
cd /path/to/bug-free-umbrella/scripts/cloud/azure/avd
...
cd bug-free-umbrella/scripts/cloud/azure/avd
```
...
- task: AzurePowerShell@5
  ...
  inputs:
    ...
    scriptType: 'FilePath'
    scriptPath: '$(System.DefaultWorkingDirectory)/scripts/cloud/azure/avd/New-AzureComputeGalleryImage.ps1'
    scriptArguments: >
...
- [Sysprep Overview](https://learn.microsoft.com/windows-hardware/manufacture/desktop/sysprep--generalize--a-windows-installation)
- [Azure VM Guest Agent](https://learn.microsoft.com/azure/virtual-machines/extensions/agent-windows)
- [Remove-SysprepBlockers.ps1 Script](../scripts/cloud/azure/avd/Remove-SysprepBlockers.ps1)
...
- [Azure Virtual Desktop](Azure-Virtual-Desktop.md) - AVD management and optimization
- [Cloud Infrastructure](../scripts/cloud/README.md) - Azure and cloud resources
- [Advanced-Scripting-Patterns](Advanced-Scripting-Patterns.md) - Expert scripting techniques
- [Performance-Tuning](Performance-Tuning.md) - Optimization strategies
- [Prerequisites](Prerequisites.md) - Required modules and setup
