...
> Expose the BugFreeUmbrella catalog — 544 PowerShell scripts — as [Model Context Protocol](https://modelcontextprotocol.io) tools. Search, preview, and validate scripts directly from Claude Desktop, Cursor, or Windsurf.
...
flowchart LR
    ...
    Catalog -->|path + synopsis| Scripts["scripts/**/*.ps1<br/>(544 scripts)"]
    MCP -->|fs read| Scripts
...
- [Script Catalog](Script-Catalog.md) — browse all 544 scripts by domain
