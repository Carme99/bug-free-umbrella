...
> Expose the BugFreeUmbrella catalog — 539 PowerShell scripts — as [Model Context Protocol](https://modelcontextprotocol.io) tools. Search, preview, and validate scripts directly from Claude Desktop, Cursor, or Windsurf.
...
flowchart LR
    ...
    Catalog -->|path + synopsis| Scripts["scripts/**/*.ps1<br/>(539 scripts)"]
    MCP -->|fs read| Scripts
...
- [Script Catalog](Script-Catalog.md) — browse all 539 scripts by domain
