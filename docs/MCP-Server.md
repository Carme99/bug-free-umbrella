...
> Expose the BugFreeUmbrella catalog — 566 PowerShell scripts on disk (381 catalogued) — as [Model Context Protocol](https://modelcontextprotocol.io) tools. Search, preview, and validate scripts directly from Claude Desktop, Cursor, or Windsurf.
...
flowchart LR
    ...
    Catalog -->|path + synopsis| Scripts["scripts/**/*.ps1<br/>(566 scripts on disk (381 catalogued))"]
    MCP -->|fs read| Scripts
...
- [Script Catalog](Script-Catalog.md) — browse all 566 scripts on disk (381 catalogued) by domain
